            ...
            <table class="table table-striped table-hover">
                ...
                try
                {
                	...
                	if(result.next())
                	{
                		...
                		<td width="22%" align="left" valign="middle"><a href="dealer_edit.jsp?company_id=<%=company_id%>">&nbsp;Update</a></td>
                						    
                        <td width="25%" align="left" valign="middle"><a href="dealer_delete.jsp?company_id=<%= company_id%>">&nbsp;&nbsp;Delete</a></td>
                						          </td>
                		</tr>
                		</table>
