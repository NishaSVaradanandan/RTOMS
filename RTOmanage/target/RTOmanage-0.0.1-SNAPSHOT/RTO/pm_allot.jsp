					    ...
					    <table width="100%" border="0">
					      <tbody>
					        <tr>
							  ...
							  <input type="text" readonly="true" name="cus_name" value="<%=pm.getCus_name() %>">
							  </td>
					          <td width="11%">&nbsp;</td>
					          <td width="11%">&nbsp;</td>
					          <td width="11%">&nbsp;</td>
					        ...
					        <tr>
					          ...
					          <td>&nbsp;</td>
					           <td><input type="text" value="KL 01 A<%=y%>"></td>
					          ...
					          <td>&nbsp;</td>
					          <td>&nbsp;</td>
					          <td align="left" valign="middle" style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">Expiry Date</td>
					          <td>&nbsp;</td>
					          <td align="left" valign="middle">
					          <input type="text" readonly="true" name="exp_date" value="<%%>">
					          </td>
					          <td>&nbsp;</td>
					          <td>&nbsp;</td>
					          <td>&nbsp;</td>
							...
							<a href="save_tp_no.jsp?temp_no=<%=pm.getTemp_no()%>">Provide</a> 
							</button></td>
					         </tr>
					          <td></td>
					          <td>&nbsp;</td>
